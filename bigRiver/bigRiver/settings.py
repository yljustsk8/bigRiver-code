"""
Django settings for bigRiver project.
...
SECRET_KEY = '1b%*&5h#-$ib*rsrx@lpswwkacs!f&unb14c=x%ctj9@h)9_#c'
...
WSGI_APPLICATION = 'bigRiver.wsgi.application'
